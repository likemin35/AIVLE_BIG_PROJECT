  ...
  return (
    ...
    >
      ...
      <Section
        ...
        title="기존 약관을 업로드해서 AI기능을 사용하고, 버전으로 깔끔하게 관리까지"
        desc={
          <>
            이미 운영 중인 약관을 불러와 저장하세요. 보라계약에 저장된 약관은 보라계약 사이트에서 직접 수정 및 AI수정 기능을 사용할 수 있습니다.
            변경 이력은 버전으로 쌓여 언제든 과거 상태를 확인할수 있습니다. 
